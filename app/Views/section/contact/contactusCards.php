<section class="w-full bg-[var(--color-black)] text-[var(--color-white)] py-24 relative z-10 overflow-hidden">
  <!-- Background glow -->
  <div class="absolute inset-0 opacity-20 bg-gradient-to-br from-[var(--color-yellow)] via-[var(--color-blue)] to-[var(--color-green)] blur-[100px]"></div>

  <div class="max-w-6xl mx-auto px-6 text-center relative z-10">
    <h2 class="text-4xl md:text-5xl font-bold mb-14 text-[var(--color-yellow)] tracking-tight">
      Contact Us
    </h2>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div class="group bg-[var(--color-black)] rounded-2xl shadow-[0_0_20px_rgba(255,255,255,0.05)] p-10 flex flex-col items-center border border-[var(--color-yellow-dark)] hover:border-[var(--color-yellow)] transition-all duration-500 hover:scale-[1.05] hover:shadow-[0_0_25px_var(--color-yellow)] hover:shadow-[inset_0_0_15px_var(--color-yellow)]">
        <div class="h-14 w-14 mb-3 text-[var(--color-yellow)] transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110">
          <!-- Call Icon -->
      ...
      <!-- Repeat for other cards, just change colors and icons -->
      <div class="group bg-[var(--color-black)] rounded-2xl shadow-[0_0_20px_rgba(255,255,255,0.05)] p-10 flex flex-col items-center border border-[var(--color-green-dark)] hover:border-[var(--color-green)] transition-all duration-500 hover:scale-[1.05] hover:shadow-[0_0_25px_var(--color-green)] hover:shadow-[inset_0_0_15px_var(--color-green)]">
        <div class="h-14 w-14 mb-3 text-[var(--color-green)] transition-transform duration-500 group-hover:-rotate-12 group-hover:scale-110">
          <!-- WhatsApp Icon -->
          <svg viewBox="0 0 20 20" fill="currentColor" class="w-full h-full">
      ...
      <div class="group bg-[var(--color-black)] rounded-2xl shadow-[0_0_20px_rgba(255,255,255,0.05)] p-10 flex flex-col items-center border border-[var(--color-blue-dark)] hover:border-[var(--color-blue)] transition-all duration-500 hover:scale-[1.05] hover:shadow-[0_0_25px_var(--color-blue)] hover:shadow-[inset_0_0_15px_var(--color-blue)]">
        <div class="h-14 w-14 mb-3 text-[var(--color-blue)] transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110">
      ...
      <!-- Email -->
      <div class="group bg-[var(--color-black)] rounded-2xl shadow-[0_0_20px_rgba(255,255,255,0.05)] p-10 flex flex-col items-center border border-[var(--color-red-dark)] hover:border-[var(--color-red)] transition-all duration-500 hover:scale-[1.05] hover:shadow-[0_0_25px_var(--color-red)] hover:shadow-[inset_0_0_15px_var(--color-red)]">
        <div class="h-14 w-14 mb-3 text-[var(--color-red)] transition-transform duration-500 group-hover:-rotate-12 group-hover:scale-110">
          <svg viewBox="0 0 20 20" fill="currentColor" class="w-full h-full">
