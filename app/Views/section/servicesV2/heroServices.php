<!-- ============================================ -->
<!-- SERVICES HERO SECTION - MATCHING HOME STYLE -->
<!-- ============================================ -->
<section id="services-hero" class="relative w-full h-screen flex items-center overflow-hidden">

  <!-- Full Background Image -->
  <div class="absolute -inset-1">
    <img src="<?= base_url('SENTINEL/public_html/assets/img/hero_services.jpg') ?>" 
  ...
  <div class="relative z-10 w-full xl:w-1/2 flex flex-col justify-center px-8 lg:px-20 py-20">
    ...
    <h1 class="text-2xl sm:text-4xl lg:text-5xl font-extrabold text-[var(--text-primary)] mb-2 leading-tight">
      ...
      <span class=""><br class="hidden lg:block">&nbsp;SERVICES<br class="block lg:hidden">&nbsp;<span class="text-[var(--accent-red)]">24/7</span></span>
    ...
    <p class="text-[var(--text-secondary)] w-2/3 xl:w-3/3 text-base sm:text-xl mb-7 ml-2 leading-snug italic">
      Real-time monitoring, two-way audio intervention, and rapid emergency response. 
      Protect your business and property with our advanced CCTV solutions.
    </p>
