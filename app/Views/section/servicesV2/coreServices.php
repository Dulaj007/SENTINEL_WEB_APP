...
<!-- ============================================ -->
<!-- CORE SERVICES SECTION - EXACT HOMEPAGE MATCH -->
<!-- ============================================ -->
<section id="core-services" class="relative py-16 sm:py-20 md:py-24 lg:py-32 overflow-hidden" 
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
    ...
    <!-- Section Header -->
    <div class="service-section-header text-center mb-16 sm:mb-20 md:mb-24">
      <!-- Badge -->
